...
MZ 세대의 자기 표현 욕구를 반영하여 실제 쇼핑 경험의 현실감을 높인 3D 커스터마이징 쇼핑몰을 설계했습니다.
기존의 2D 상품 이미지가 실제 제품과 달라 발생했던 고객의 불만과 이탈 문제를 분석하여, 이를 3D 시뮬레이션 기술로 해결하고자 했습니다.

프로젝트 과정에서 사용자의 의견을 지속적으로 반영하여, 단순히 기술적인 구현에 머물지 않고, 실제 쇼핑 환경에서 사용자 경험을 어떻게 향상시킬 수 있는지 고민했습니다.
이를 통해 기존 쇼핑몰 대비 구매 확신과 사용자 만족도를 크게 개선할 수 있었습니다.
<br>
